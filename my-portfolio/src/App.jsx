                    ...
                    >
                        {theme === 'dark' ? (
                            ...
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                <path d="M12 4V2M12 22v-2M4 12H2M22 12h-2M5 5L3.6 3.6M20.4 20.4 19 19M5 19l-1.4 1.4M20.4 3.6 19 5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <div className="container hero-grid">
                        ...
                        <div className="hero-card">
                            <div className="profile">
                                {/* bigger avatar for desktop, responsive in CSS */}
                                <img src="/image.jpg" alt="Akmaludin" className="avatar-img avatar" width="200" height="200" />
                                <h3>Akmaludin</h3>
